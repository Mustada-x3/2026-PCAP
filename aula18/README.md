...
- O jogo funciona ............: par_impar.py, linhas 9 a 63
- Funções e operador % .......: par_impar.py, linha 11 a 15, 41 (def/return, soma % 2)
- Adições pessoais
 * Caso o jogador ou a máquina atingam 3 pontos durante as rodadas o jogo para automaticamente.
 * Vencedor final: determina qual foi o vencedor com base nos pontos de todas as rodadas acumuladas, ou seja, quem obteve mais pontos no final de todas as rodadas é declarado como vencedor definitivo.
